...
To test the backpressure mechanism, you can use a load testing tool:
...
When capacity is exceeded, you'll see:
- 503 responses
- Increased `rejected_requests` metric
- Readiness endpoint returns `DOWN` status
...
- Ensure `JWT_SECRET` is set (minimum 32 characters recommended)
